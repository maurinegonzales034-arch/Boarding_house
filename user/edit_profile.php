        ...
        <div class="section">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="guardian" value="<?php echo htmlspecialchars($user['guardian_number']); ?>" required>
                </div>

                <div class="form-group">
                    <label>Home Address / Location:</label>
                    <textarea name="location" required><?php echo htmlspecialchars($user['home_location']); ?></textarea>
                </div>
